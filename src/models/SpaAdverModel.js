...
const adverSchema = new Schema(
  {
    ...
    tags: { type: [String], required: [false, "The field is requiered"] },
    ...
    activities: { type: String, required: [false, "The field is requiered"] },
    ranking: { type: Number, required: [false, "The field is requiered"] },
